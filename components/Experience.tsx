...
export const Experience = () => {
    ...
    return (
        ...
        <section className="justify-center w-120 md:w-160" id="experience">
            ...
            <div className="flex h-30 md:h-29 border-2 rounded-xl border-white">
                <div className="flex px-6 md:p-0 gap-4 md:gap-0">
                <ul>
                    <li className="relative grid justify-center gap-1 p-1 py-8 md:p-7 md:py-full">
                        ...
                        <div className="relative z-10 bg-white rounded-full p-1">
                            <Image
                                src={Icon1}
                                alt="uinsi"
                                className="rounded-full w-20 h-10 md:w-12 md:h-12"
                            />
                        </div>
                    </li>
                </ul>
                <div className="grid p-1 md:p-3 items-center justify-center">
