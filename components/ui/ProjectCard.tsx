...
export const ProjectCard = () => {
    return (
        ...
        href='https://anime-puzzle-3x3.vercel.app/'>
    ...
    hover:-translate-y-2 hover:shadow-lg">
        ...
        <a className='justify-center items-center flex'
        href='https://portfolio-sigma-virid-u677bz60w1.vercel.app/'>
        <section className="w-82 h-78 md:w-80 md:h-80 border-1 border-white rounded-md transition-transform duration-300 md:mb-0 mb-6
    hover:-translate-y-2 hover:shadow-lg">
            <Image 
            src={projectImage2}
            ...
            <section className='flex px-3 p-1 md:-mt-2 gap-2 text-sm items-center'>
                ...
                <div className='bg-white w-22 h-5 items-center justify-center rounded-md text-center'><h1 className="text-center mt-0.5">Tailwindcss</h1></div>
                </div>
            </section>
        </section>
        </a>
